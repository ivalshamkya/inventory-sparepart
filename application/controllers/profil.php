...
class Profil extends CI_Controller{
	...
	public function proses_ubah()
	{
		...
		$this->form_validation->set_rules('nama_karyawan', 'Nama diubah','required');		$this->form_validation->set_rules('email', 'Email diubah','required');		
		$this->form_validation->set_rules('telepon', 'Telepon diubah','required');		$this->form_validation->set_rules('alamat', 'Alamat diubah','required');		$this->form_validation->set_rules('username', 'Username diubah','required');	$this->form_validation->set_rules('password', 'Password diubah','required');
