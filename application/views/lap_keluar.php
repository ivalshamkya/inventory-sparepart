<div class="container-fluid">
    ...
    <div class="card mb-2">
        <div class="card-header bg-primary text-white">
            Filter Data Spare Part Keluar
        </div>
        <div class="card-body">
            <form method="POST" action="<?php echo base_url('lap_keluar') ?>" class="form-inline">
                ...
                <a class="btn btn-danger mb-2 ml-3" target="_blank" href="<?php echo base_url().'lap_keluar/cetakLaporan/?dari='.set_value('dari').'&sampai='.set_value('sampai') ?>"><i class="fas fa-print"></i> Cetak</a>
            </form>
        </div>
    </div>
