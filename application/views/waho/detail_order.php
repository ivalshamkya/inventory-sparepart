...
<body id="page-top">
    <div class="wrapper">
        <!-- load sidebar -->
        <?php $this->load->view('waho/sidebar.php') ?>
                    ...
                    <div class="row">
                        <div class="col">
                            <div class="card shadow">
                                ...
                                <?php endif; ?>
                                <div class="card-body">
                                    <form action="<?= base_url('waho/list_order/approve') ?>" id="form-tambah" method="POST">
                                        <h5>Data Karyawan</h5>
                                        <hr>
                                        <div class="form-row">
                                            ...
                                            <table class="table table-bordered" id="tableDetail">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($detail_order as $key => $detail) { ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select name="supplier[]" id="supplier-<?= $i ?>" class="form-control" required readonly>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        ...
                                                        <?php if($detail_order[0]->apprWAHO == '1' || $detail_order[0]->apprWAHO == '0'): ?>
                                                        <?php else: ?>
        ...
        function Alert(approve = true) {
            ...
            swalWithBootstrapButtons.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: `<?php echo base_url(); ?>waho/list_order/${approve ? 'approve' : 'reject'}/<?= $list_order[0]->id_order ?>`,
                        method: 'GET',
                        success: () => {
                            Swal.fire({
                                ...
                                if (result.dismiss === Swal.DismissReason.timer) {
                                    location.href = '<?= base_url() ?>waho/list_order';
                                }
                            });
                        },
                        error: (error) => {
