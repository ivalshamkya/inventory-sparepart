    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <form method="get" action="<?= base_url('secondhead/list_order') ?>" class="d-flex align-items-center mb-1">
                    ...
                    <tbody>
                        ...
                        foreach ($detail_order as $key => $value) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= base_url('secondhead/list_order/detail_order/' . $value->id_order) ?>" class="btn btn-secondary">Detail</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>
