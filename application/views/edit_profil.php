    ...
    <div id="content">
        ...
        <div class="clearfix">
            ...
            <div class="float-right">
                <a href="<?php echo base_url('profil') ?>" class="btn btn-secondary btn-sm"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a>
            </div>
        </div>
        <hr>
            ...
            <div class="col-md-6">
                <div class="card shadow ">
                    ...
                    <?php foreach($ubah as $u) : ?>
                        <div class="card-body">
                            <form action="<?= base_url('profil/proses_ubah') ?>" id="form-profil" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group float-right">
                                    ...
                                    <a href="<?php echo base_url('profil') ?>" class="btn btn-secondary"><i class="fa fa-reply"></i>&nbsp;&nbsp;Kembali</a>
                                </div>
                            </form>
                        </div>
                    <?php endforeach; ?>
