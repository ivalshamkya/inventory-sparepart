<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-danger sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nama Sistem -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<?php echo base_url('pic/dashboard') ?>">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="<?php echo base_url('pic/dashboard') ?>">
            ...
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('pic/list_order') ?>">
            ...
            <!-- Lainnya -->
            <li class="nav-item">
                <a class="nav-link" href="<?php echo base_url('pic/profil') ?>">
